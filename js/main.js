(function () {
  ...
  const categories = [
    ...
    { id: 'cases', title: 'Cases', img: './img/cases-1.png', products: [
    ...
    { id: 'headphones', title: 'Headphones', img: './img/headphones-1.png', products: [
    ...
    { id: 'cables', title: 'Cables', img: './img/cable-1.png', products: [
    ...
    { id: 'powerbanks', title: 'Powerbanks', img: './img/powerbank-1.png', products: [
  ...
  function renderCards() {
    ...
    if (!initialLayoutDone) {
      ...
      track.classList.add('is-initial');
        categories.forEach((cat) => {
          ...
          card.innerHTML = `
            ...
            <div class="acc-title"><span class="acc-title-text">${cat.title}</span></div>
            <div class="acc-info">
      ...
      // Compute and set curtain width per card based on the longest word
      elements.forEach((card) => {
        ...
        // Create a measurer in the same card to respect inheritance
        ...
        measurer.remove();
        // Add horizontal padding (12px left + 12px right)
        const padded = Math.ceil(maxPx + 24);
        card.style.setProperty('--curtain-w', padded + 'px');
